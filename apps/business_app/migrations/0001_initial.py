    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_by_weight', models.FloatField(validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Precio por libra')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sell_price', models.FloatField(validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Precio')),
                ('weight', models.FloatField(validators=[django.core.validators.MinValueValidator(limit_value=0)], verbose_name='Peso')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='business_app.category', verbose_name='Categoría')),
            ],
            options={
